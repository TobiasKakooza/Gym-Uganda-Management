<?php
session_start();
// Check if the user is logged in and stored on the session
...
<html lang="en">
<head>
    <title>Ugandan Gym System Admin</title>
    <meta charset="UTF-8" />
...
<!--Header-part-->
<div id="header">
    <h1><a href="">Ugandan Perfect Gym Admin</a></h1>
</div>
<!--close-Header-part--> 
                            ...
                            <div class="span5">
                                <table class="">
                                    <tbody>
                                        ...
                                        <tr>
                                            <td><h4>Ugandan Perfect GYM Club</h4></td>
                                        </tr>
                                        <tr>
                                            <td>5021  Wetzel Lane, Kampala</td>
                                        </tr>

                                        <tr>
                                            <td>Tel: +256 701 234 567</td>
                                        </tr>
                                        <tr>
                                            <td >Email: support@ugandangym.com</td>
                                        </tr>
                                    </tbody>
                                </table>
                            </div>
