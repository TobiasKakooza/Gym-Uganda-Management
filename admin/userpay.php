...
<form role="form" action="index.php" method="POST">
    <?php 
            ...
            $amountpayable_ugx = $amount * $plan; // Amount in Ugandan Shillings
            
            include 'dbcon.php';
            date_default_timezone_set('Africa/Kampala'); // Changed timezone to Kampala
            ...
            //update query
            $qry = "UPDATE members SET amount='$amountpayable_ugx', plan='$plan', status='$status', paid_date='$curr_date', reminder='0' WHERE user_id='$id'";
                                            ...
                                            <tr>
                                                <td class="content-block">
                                                    <table class="invoice">
                                                        <tbody>
                                                        <tr>
                                                            <td><div style="float:left">Invoice #GMS_<?php echo(rand(100000,10000000));?> <br> 5021  Wetzel Lane, <br>Kampala </div><div style="float:right"> Last Payment: <?php echo $paid_date?></div></td> <!-- Changed Williamsburg to Kampala -->
                                                        </tr>
                                                            ...
                                                            <td>
                                                                <table class="invoice-items" cellpadding="0" cellspacing="0">
                                                                    ...
                                                                    <tr>
                                                                        ...
                                                                        <td class="alignright"><?php echo number_format($amount); ?> UGX</td>
                                                                    </tr>
                                                                   
                                                                    
                                                                    <tr class="total">
                                                                        <td class="alignright" width="80%">Total Amount</td>
                                                                        <td class="alignright"><?php echo number_format($amountpayable_ugx); ?> UGX</td>
                                                                    </tr>
                                                                </tbody></table>
                                                            </td>
                                                        </tr>
