        ...
        <div class='widget-box'>
          ...
          <div class='widget-content nopadding'>
            ...
            while($row=mysqli_fetch_array($result)){
              // Convert amount from dollars to UGX (Ugandan Shillings)
              $amount_ugx = $row['amount'] * 3550; // Assuming 1 USD = 3550 UGX (You can adjust this conversion rate accordingly)
              echo"<tbody> 
                ...
                <td><div class='text-center'>".$amount_ugx." UGX</div></td>
