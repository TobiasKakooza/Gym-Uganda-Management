...
<!--Header-part--><!-- Visit Tobias Developerfor more projects -->
<div id="header">
...
<div class="container-fluid">
  ...
  <div class="form-horizontal">
    <div class="control-group">
      ...
      <div class="controls">
        <label>
          <input type="radio" value="Fitness" name="services" data-price="203500" />
          Fitness <small>- 203500 UGX per month</small></label>
        <label>
          <input type="radio" value="Sauna" name="services" data-price="129500" />
          Sauna <small>- 129500 UGX per month</small></label>
        <label>
          <input type="radio" value="Cardio" name="services" data-price="148000" />
          Cardio <small>- 148000 UGX per month</small></label>
      </div>
    </div>
    ...
    <div class="control-group">
      ...
      <div class="controls">
        <div class="input-append">
          <span class="add-on">UGX</span> 
          <input type="number" id="total_amount" placeholder="0" name="amount" class="span11" readonly>
        </div>
      </div>
    </div>
...
<script>
  // Get radio buttons
  var radioButtons = document.querySelectorAll('input[type="radio"][name="services"]');
