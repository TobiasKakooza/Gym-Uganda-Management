  ...
  <div class="container-fluid">
    <div class="quick-actions_homepage">
      <ul class="quick-actions">
       ...
       <li class="bg_lg span3"> <a href="payment.php" style="font-size: 16px;"> <i class=""></i><b>UGX</b><br><br> Total Earnings: <?php include 'income-count.php'; ?></a> </li>
...
<!--Chart-box-->    
    <div class="row-fluid">
      ...
      </div><!-- Visit Tobias Developerfor more projects -->
...
<!--End-Chart-box--> <!-- Visit Tobias Developerfor more projects -->
    <!-- <hr/> -->
    <div class="row-fluid">
      <div class="span6">
        <div class="widget-box">
...
<script src="../js/excanvas.min.js"></script> <!-- Visit Tobias Developerfor more projects -->
