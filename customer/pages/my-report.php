...
while($row=mysqli_fetch_array($result)){
    // Conversion rate from USD to Ugandan Shilling
    $exchange_rate = 3560; // This is just a sample rate, replace it with the actual rate

    // Convert charge to Ugandan Shilling
    $amount_ugx = $row['amount'] * $exchange_rate;
?> 
...
<body><!-- Visit Tobias Developerfor more projects -->
            ...
            <div class="row-fluid">
              ...
              <div class="span8">
                <table class="table table-bordered table-invoice-full">
                  ...
                  <tbody>
                    <tr>
                      ...
                      <td><div class="text-center"><?php echo 'UGX '.$amount_ugx; ?></div></td>
                ...
                <table class="table table-bordered table-invoice-full">
                  <tbody>
                    <tr>
                      <td class="msg-invoice" width="55%"> <div class="text-center"><h4>Last Payment Done:  UGX <?php echo $amount_ugx; ?>/-</h4>
