<?php
session_start();
//the isset function to check if the username is already logged in and stored on the session
if(!isset($_SESSION['user_id'])){
    header('location:../index.php');  
}

// Conversion rate from USD to UGX
$conversion_rate = 3600; // Example conversion rate
      ...
      while($row=mysqli_fetch_array($result)){
          echo"<tbody> 
            <tr>
              ...
              <td><div class='text-center'>".number_format($row['amount'] * $conversion_rate)." UGX</div></td>
